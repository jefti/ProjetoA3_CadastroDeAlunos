namespace ProjetoA3_CadastroDeAlunos.Src.Forms.LandingPage
{
    partial class LandingPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            Land_txt_email = new Label();
            Land_txt_telefone = new Label();
            Land_lbl_nome = new Label();
            Land_lbl_endereco = new Label();
            ...
            panel1.Controls.Add(Land_txt_email);
            panel1.Controls.Add(Land_txt_telefone);
            panel1.Controls.Add(Land_lbl_nome);
            panel1.Controls.Add(Land_lbl_endereco);
        ...
        private Label Land_txt_nome;
        private Label Land_txt_endereco;
        private Label Land_txt_cpf;
        private Label Land_txt_email;
        private Label Land_txt_telefone;
        private Label Land_lbl_nome;
        private Label Land_lbl_endereco;
